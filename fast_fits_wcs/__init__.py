"""fast_fits_wcs: a minimal, JAX-optimized, APE 14-compliant celestial FITS WCS."""
...
# created. Set FAST_FITS_WCS_X64=0 to opt out (e.g. if you share a process with
# a float32 ML pipeline and can tolerate the precision loss).
import os as _os

if _os.environ.get("FAST_FITS_WCS_X64", "1") != "0":
    import jax as _jax
